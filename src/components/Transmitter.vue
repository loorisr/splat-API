    ...
    <form novalidate>
        ...
        <div class="row g-2 mt-2">
            <div class="col-6">
                ...
                <input v-model="transmitter.tx_power" type="number" class="form-control form-control-sm" id="tx_power" required min="0.001" step="0.1" data-bs-toggle="tooltip" title="Transmitter power in watts (>0)." />
